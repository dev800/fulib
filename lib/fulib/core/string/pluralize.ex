defmodule Fulib.String.Pluralize do
  # refer url: https://github.com/nurugger07/inflex/blob/master/lib/inflex/pluralize.ex
  ...
  def singularize(word) when is_atom(word) do
    find_match(@singular, to_string(word)) |> Fulib.to_atom()
  end

  def singularize(word), do: find_match(@singular, word)

  def pluralize(word) when is_atom(word) do
    find_match(@plural, to_string(word)) |> Fulib.to_atom()
  end
